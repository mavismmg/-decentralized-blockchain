# -*- coding: utf-8 -*-
"""
Created on Tue Mar  8 11:57:27 2022
@author: Mateus Jorge - mavismmg
"""
...
if __name__ == '__main__':
    ...
    def mine_block():
        ...
        blockchain.add_transaction(sender=node_address, receiver='User01', amount=10)
    ...
    def is_valid():
        ...
        if is_valid:
            response = {'message': f'{blockchain.chain} chain is valid.'}
        else:
    ...
    def add_transaction():
        ...
        if not all (key in json for key in transactions_keys):
            # If some key is missing, return a bad request message
            return 'Element from transaction is missing', 400
    ...
    def connect_node():
        ...
        response = {'message': 'Nodes are connected. Contains the following nodes: ',
    ...
    def replace_chain():
        ...
        if is_chain_replaced:
            response = {'message': 'Node had different chain, chain is now replaced',
                        'new_chain': blockchain.chain}
        else:
            response = {'message': 'Passed. Chain is the largest one',
